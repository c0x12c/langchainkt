...
import langchainkt.model.embedding.AllMiniLmL6V2QuantizedEmbeddingModel
...
class EmbeddingModelTextClassifierTest {
  ...
  private enum class CustomerServiceCategory {
  ...
  private val examples = mapOf(
    CustomerServiceCategory.BILLING_AND_PAYMENTS to mutableListOf(
    ...
    CustomerServiceCategory.TECHNICAL_SUPPORT to mutableListOf(
    ...
    CustomerServiceCategory.ACCOUNT_MANAGEMENT to mutableListOf(
    ...
    CustomerServiceCategory.PRODUCT_INFORMATION to mutableListOf(
    ...
    CustomerServiceCategory.ORDER_STATUS to mutableListOf(
    ...
    CustomerServiceCategory.RETURNS_AND_EXCHANGES to mutableListOf(
    ...
    CustomerServiceCategory.FEEDBACK_AND_COMPLAINTS to mutableListOf(
  ...
  @Test
  @Disabled
  fun should_return_one_category_by_default() {
    val classifier: TextClassifier<CustomerServiceCategory> = EmbeddingModelTextClassifier(
      AllMiniLmL6V2QuantizedEmbeddingModel(),
      examples
    )
    val categories = classifier.classify("Yo where is my order?")
    assertThat(categories).containsExactly(CustomerServiceCategory.ORDER_STATUS)
  }

  @Test
  @Disabled
  fun should_return_multiple_categories() {
    val classifier: TextClassifier<CustomerServiceCategory> = EmbeddingModelTextClassifier(
      AllMiniLmL6V2QuantizedEmbeddingModel(),
      examples,
      2,
    ...
    val categories = classifier.classify("Bro, this product is crap")
    assertThat(categories).containsExactly(CustomerServiceCategory.RETURNS_AND_EXCHANGES, CustomerServiceCategory.FEEDBACK_AND_COMPLAINTS)
  }

  @Test
  @Disabled
  fun should_classify_respecting_minScore() {
    val classifier: TextClassifier<CustomerServiceCategory> = EmbeddingModelTextClassifier(
      AllMiniLmL6V2QuantizedEmbeddingModel(),
      examples,
      2,
    ...
    val categories = classifier.classify("Bro, this product is crap")
    assertThat(categories).containsExactly(CustomerServiceCategory.RETURNS_AND_EXCHANGES)
  }

  @Test
  @Disabled
  fun should_classify_respecting_meanToMaxScoreRatio_1() {
    val classifier: TextClassifier<CustomerServiceCategory> = EmbeddingModelTextClassifier(
      AllMiniLmL6V2QuantizedEmbeddingModel(),
      examples,
      1,
    ...
    val categories = classifier.classify("Bro, this product is crap")
    assertThat(categories).containsExactly(CustomerServiceCategory.FEEDBACK_AND_COMPLAINTS)
  }

  @Test
  @Disabled
  fun should_classify_respecting_meanToMaxScoreRatio_0() {
    val classifier: TextClassifier<CustomerServiceCategory> = EmbeddingModelTextClassifier(
      AllMiniLmL6V2QuantizedEmbeddingModel(),
      examples,
      1,
