...
/**
 * Splits the provided [Document] into lines and attempts to fit as many lines as possible
 ...
 *
 *
 * If a single line is too long and exceeds `maxSegmentSize`,
 ...
 */
class DocumentByLineSplitter : HierarchicalDocumentSplitter {
  constructor(
  ...
  public override fun split(text: String): Array<String> {
    return text.split("\\s*\\R\\s*".toRegex()) // additional whitespaces are ignored
